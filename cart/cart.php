						...
						<?php
							...
							if ( ! $_product->is_visible() ){
								...
								if($_SESSION['product_id'] == $product_id){
								 echo '<span style="font-weight: 600;">'.$_SESSION['cartUC'].'</span><br>';
								 if($_SESSION['cartEs'])
								 	echo '<span style="line-height: 22px;">'.$_SESSION['cartEs']. '</span> + <span>' . $_SESSION['cartNA'].'</span>';
								}else
									echo apply_filters( 'woocommerce_cart_item_name', $_product->get_title(), $cart_item, $cart_item_key );
							}
							// Meta data
...
<div class="cart-collaterals">
	<div class="AuthorizeNetSeal"> <script type="text/javascript" language="javascript">var ANS_customer_id="eb45cde6-faf9-4e40-a66a-4c7173522d58";</script> <script type="text/javascript" language="javascript" src="https://verify.authorize.net/anetseal/seal.js" ></script></div>
