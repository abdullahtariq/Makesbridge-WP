...
<form id="order_review" method="post">
	...
	<div id="payment">
		...
		<div class="form-row">
        	<p class="pop_termslink">By clicking "Submit Order" above you agree to <a href="javascript:void(0);" onclick="showsupop('termspop','3');">MakesBridge Technology's Terms of Service</a></p>
