...
<div id="order_review">
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			<p class="pop_termslink" style="margin-top:6px; width:auto;">By clicking "Submit Order" you agree to <a href="javascript:void(0);" onclick="showsupop('terms2pop','3');">MakesBridge Technology's Terms of Service</a></p>
			...
			<?php
			$order_button_text = apply_filters( 'woocommerce_order_button_text', __( 'Submit Order', 'woocommerce' ) );
