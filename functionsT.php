	  ...
	  foreach($videos as $video):
		  ...
		  <div class="thumbnail">';
			...
			$str .= '<div class="img">';
				...
				{
					$str .= '<div> <a class="previewbtn wp-video-lightbox" onclick="addView('. $video->ID .',\'http://player.vimeo.com/video/'. get_post_meta($video->ID,'video_id',true) .'?title=0&amp;byline=0&amp;portrait=0\')"><span></span></a> </div>
	...
	$i=1;
	  foreach($vids as $vid):
		  ...
		  <div class="thumbnail">';
			...
			$str .= '<div class="img">
			  <div> <a class="previewbtn wp-video-lightbox" onclick="addView('. $video->ID .',\'http://player.vimeo.com/video/'. get_post_meta($video->ID,'video_id',true) .'?title=0&amp;byline=0&amp;portrait=0\')"><span></span></a> </div>
	  ...
	  foreach($offs as $off):
		  ...
		  <div class="thumbnail" style="background:none;">
			<div class="img2" style="height:160px; line-height:240px;">			  
			  <div>
          	<a class="previewbtn" href="javascript:void(0);" onclick="addView('.$offer->ID.')"><span></span>View Detail</a>
          	<a class="selectbtn" href="javascript:void(0);" onclick="addClick('. $offer->ID .',\'http://www.makesbridge.com/congratulations?add-to-cart='. get_post_meta($offer->ID,'link_product_id',true) .'\')"><span></span>Select Offer</a>
          </div>
          <img src='. get_template_directory_uri() .'/thumb.php?src='.$image[0].'&w=99&h=99" alt="">
			  </div>
