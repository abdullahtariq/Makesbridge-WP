...
<html lang="en">
	<head>
        ...
        <!--<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/jmpressjs_animation.css" />
        
        <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
        <script type="text/javascript" src="http://linkedinpartner.makesbridge.com/wp-content/themes/twentythirteen/js/jmpress.min.js"></script>
        <script type="text/javascript" src="http://www.makesbridge.com/wp-content/themes/mksteam/js/jquery.jmslideshow.js"></script>-->
...
$('.slides').bxSlider({
  ...
  pause: 8000
        ...
        <link rel="shortcut icon" href="http://www.makesbridge.com/wp-content/themes/mksteam/images/favicon.ico">
...
<script language="javascript">
			...
			function validateOfferForm() 
			{
				...
				if(!cmnErr && !emailErr)
				{
					...
					var str = 'fname='+fname+'&email='+email+'&phone='+phone+'&src='+$('#off_source').val();
                    $.ajax({
                        url:"<?php echo bloginfo('wpurl'); ?>/wp-admin/admin-ajax.php",
                        type:'POST',
