...
{   
	...
	//close connection
	curl_close($ch);
	header('header: http://thisweek.makesbridge.com/congratulations?name='.urlencode($fname) . ' ' . urlencode($lname));
	/*if(key($json_a) == 'Error')
...
get_header(); ?>
    ...
    <div class="main">
    	<div class="main_wrap" style="position:relative; z-index:1000;">
        	<div class="home-special-offer">
            	<h2>Special Offer!</h2>
                <p>Subscribe and we’ll pay your subscription to these popular apps.</p>
                <span class="clear"></span>
                <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home-spoffer-sficon.png" width="81" height="57" style="border:0;" />
                <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home-spoffer-netsuite-icon.png" width="78" height="45" style="border:0;" />
                <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home-spoffer-highriseicon.png" width="48" height="52" style="border:0;" />
                <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home-spoffer-liicon.png" width="103" height="28" style="border:0;" />
                <span class="clear"></span>
            </div>
            <!--<div class="clear"></div>
            <div class="trialform">                    
                ...
                <div class="form" style="margin-top:20px; width:400px;">                        
                    ...
                    <div class="home_termslink">
                        By submitting this information you agree to our <a href="javascript:void(0);" onclick="showtospop();">Terms of Service</a>                            
                    </div>
                </div>
                </a>                    
            </div>
	...
	<div class="main">
		<div class="main_wrap">
			<div class="stories" style="margin:0 auto 100px;">
