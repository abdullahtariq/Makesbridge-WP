(function( $, undefined ) {
	...
	$.JMSlideshow.defaults 		= {
		...
		jmpressOpts	: {
			...
			keyboard		: { use : false },
			animation		: { transitionDuration : 'substep 0 + 1s', transitionTimingFunction: 'ease-in-out' }
		},
	...
	$.JMSlideshow.prototype 	= {
		...
		_layout				: function() {
			...
			if( this.options.dots ) {
				...
				{
					this.$dots.append( ( i === 0 ) ? '<span class="jms-dots-current"/>' : '<span/>' );
				}
