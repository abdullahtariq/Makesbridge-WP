			...
			<div class="boxes">
				<div class="columns">
					<div class="one_third box">
					  ...
					  <div class="partner_logo"><img src="<?php echo bloginfo('wpurl'); ?>/emial_template/template_demo/00d/1.png" alt="service"></div>
					...
					<div class="one_third box">
					  ...
					  <div class="partner_logo"><img src="<?php echo bloginfo('wpurl'); ?>/emial_template/template_demo/00d/2.png" alt="service"></div>
					...
					<div class="one_third box last">
					  ...
					  <div class="partner_logo"><img src="<?php echo bloginfo('wpurl'); ?>/emial_template/template_demo/00d/3.png" alt="service"></div>
