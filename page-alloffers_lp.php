...
<script language="javascript">
			...
			<div class="header">
				<div class="left_header">
					<a target="_blank" href="#">
						<img class="img_logo" width="224" height="51" src="http://makesbridge.com/emial_template/template/activationnewsletter2/img/mks_hd_logo.png" alt="Makesbridge" border="0" style="width: 224px;height: 51px;max-width: 224px;max-height: 51px;display: block;border: 0px;outline: none;text-decoration: none;">
					</a>
				</div>
				<div class="right_header">
					<div class="ctg_wrap">
						<img class="conn_img" width="237" height="20" src="http://makesbridge.com/emial_template/template/activationnewsletter2/img/conn.png" alt="Connect to Grow " border="0" style="margin: 15px 0 0; width: 237px;height: 20px;max-width: 237px;max-height: 20px;display: block;border: 0px;outline: none;text-decoration: none;">
					</div>
				</div>
				<div class="clear"></div>
			</div>
	...
	<div class="main" style="background: #ecf3fa;">
		<div class="main_wrap">
			<div class="fp_01" style="padding: 50px 0 40px;">
				<p style="  font-size: 36px;  color: #4292bb; text-align: center; font-family: 'proxima_nova_semibold', Arial, sans-serif;line-height: 37px;">Don't miss these offers for the world:</p>
			</div>
			
			<div class="boxes">
				<div class="columns">
					<div class="one_third box">
					  <h2 class="h2box c_orange">Free Highrise<br>Subscription!</h2>
					  <div class="partner_logo"><img src="https://makesbridge.com/emial_template/template_demo/00d/1.png" alt="service"></div>
					  <p class="box_headline">If you're a business not yet taking advantage of what CRM has to offer...</p>
					  <p class="box_p">We've partnered with Highrise to offer you a free CRM account, forever.</p>
					  <p class="box_p">You'll get free subscription of Highrise CRM with our Pro and Enterprise Automated Email Marketing Packages</p>
					...
					<div class="one_third box">
					  <h2 class="h2box c_mintgreen">Free DataTrim<br>Subscription!</h2>
					  <div class="partner_logo"><img src="https://makesbridge.com/emial_template/template_demo/00d/2.png" alt="service"></div>
					  <p class="box_headline">If you need help cleaning up your contacts database...</p>
					  <p class="box_p">We've partnered with DataTrim to offer you world class data cleaning<br>services for free.</p>
					  <p class="box_p">You'll get free subscription of DataTrim with our Pro and Enterprise Automated Email Marketing Packages</p>
					...
					<div class="one_third box last">
					  <h2 class="h2box c_lblue">Free 5 Hours Salesforce and NetSuite Consultancy!</h2>
					  <div class="partner_logo"><img src="https://makesbridge.com/emial_template/template_demo/00d/3.png" alt="service"></div>
					  <p class="box_headline">Not getting the most out of your CRM subscription?</p>
					  <p class="box_p">We've partnered with recognized consultants to offer you free consultancy.</p>
					  <p class="box_p">You can get 5 hours of free Salesforce or Netsuite consultancy on the purchase of our PRO & Enterprise Email marketing packages.</p>
	...
	<div class="main" style="background: #ffffff;">
		<div class="main_wrap" style="padding: 50px 0 0;">
			<div class="fp_01" style="padding: 0px 0 40px;">
				<p style="  font-size: 36px;  color: #4292bb; text-align: center; font-family: 'proxima_nova_semibold', Arial, sans-serif;line-height: 37px;">With these offers get the most advanced yet user-friendly email marketing interface ever!</p>
			</div>
	...
	<div class="main" style="background: #ecf3fa;">
		<div class="main_wrap" style="padding: 50px 0 40px;">
			<div class="fp_01">
				<p style="font-size: 22px;  color: #7f9bae; text-align: center;font-family: 'proxima_nova_bold', Arial, sans-serif;line-height: 30px;">Sign up here, or take a video tour of the new User Interface</p>
			</div>
			
			<div class="vdtour">
				<a href="" class="button_vd">
					Video Tour
				</a>
			</div>
			<div class="clear"></div>
			    ...
			    <div id="requestdemo_sec1">
				  <div class="requestdemo_sec1_left">
						...
						<div class="wrap_newform">
							...
							<div id="inquiry" class="demoinputbg demotabg demomessagebg">
                                <label>Inquiry</label>
                                <textarea name="demomessage" id="demomessage" placeholder="Examples: Why is your CRM integration better than others? - OR - I'd like to see how your marketing tools suit my needs."></textarea>                            
                                <span id="demomessage_erroricon" class="erroricon" data-placement="right" data-trigger="hover" data-toggle="popover" data-original-title="" title=""></span>
                                <div class="clear"></div>
	...
	<div class="main" style="background: #4292bb;">
		<div class="main_wrap" style="padding: 47px 0;">
			<div class="fp_01">
				<center><img class="img_footer" width="234" height="56" src="https://makesbridge.com/emial_template/template/crm/img/logo_footer.png" alt="" border="0" style="width: 234px;height: 56px;max-width: 234px;max-height: 56px;border: 0px;outline: none;text-decoration: none; margin: 0 0 30px;"></center>
