...
<script type="text/javascript">
	...
	function showChart()
	{
		...
		$('.pp_content_container').css('background-color','#e9edf6');
		$('.pp_fade').css('background-color','#e9edf6');
		$('.pp_inline').css('background-color','#e9edf6');
		$('.pp_left').css('padding-left','0');
		$('.pp_right').css('padding-right','0');
		$('#tilehead').show();
		$('#tilebottom').show();
		$('.pp_pic_holder').css('width','1100px');
		$('.pp_content').css('width','');
		$('.pp_content').css('height','');
		$('.pp_inline').css('height','');
