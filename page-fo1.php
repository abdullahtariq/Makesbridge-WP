...
/* Template Name: Freedom Offers 1 */
    ...
    <div class="temp-filters clearfix fo">
      ...
      <div class="srt-div" style="margin-right:10px;">
        ...
        <div class="input-append search" id="">
          <input type="text" style="width:190px; height:20px;" class="search-control show-image" placeholder="search offers" id="offersearchinput" onkeypress="onkp(event)" />
...
<div class="pp_pic_holder pp_default foff" style="top: 410.5px; left: 282.5px; display: none; width: 772px;">
  ...
  <div class="pp_content_container" style="position:relative;">
    <div class="pp_left">
      <div class="pp_right">
        <div class="pp_content" style="height: 420px; width: 740px;">
