...
<script language="javascript">
				...
				{					
                    ...
                    $.ajax({
                        ...
                        success:function(results)
                        {
                            ...
                            window.location = 'http://thisweek.makesbridge.com/thank-you';
                        }
                    });
					return false;
				}
	...
	<div class="main" style="background: #ecf3fa;">
		<div class="main_wrap" style="padding: 67px 0 0;">
			<div class="fp_01" style="padding: 0px 0 40px;">
				<p style="  font-size: 36px;  color: #4292bb; text-align: center; font-family: 'proxima_nova_semibold', Arial, sans-serif;line-height: 37px;">Have a business challenge at hand?</p>
			</div>
			<div><img src="http://makesbridge.com/emial_template/template_demo/00d/00baner.png" alt="service" style="border: 0;display: block;margin: auto auto;"></div>
			<div class="clear"></div>
		</div>
	</div>
	<!-- END: Module -->
	...
	<div class="main" style="background: #ffffff;">
		<div class="main_wrap" style="padding: 67px 0;">
			<div style="float: left;width: 50%;">
				<div style="width: 83%;margin: auto auto;">
					<h2 style="font-size: 24px;  color: #4292bb;  text-align: center;  font-family: 'proxima_nova_semibold', Arial, sans-serif;  line-height: 29px;">To learn more about any of these offers, please provide your contact details below.</h2>
			...
			<div style="float: right;width: 50%;">
				<div style="margin: 104px 0 0;"><img src="https://makesbridge.com/emial_template/template_demo/00d/so_big.png" alt="service" style="border: 0;display: block;margin: auto auto;"></div>
			</div>
