...
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/home2.css" media="screen" />
	...
	<div class="main">    	
    	...
    	<div class="main_wrap" style="position:relative; z-index:1000;">
        	<div class="home-special-offer" onclick="window.location='<?php echo bloginfo("url"); ?>/offers';">
            	<h2>Freedom Offers!</h2>
                <p>Subscribe and we'll pay your subscription to one of these popular apps.</p>
                <span class="clear"></span>
                <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home-spoffer-sficon.png" width="81" height="57" style="border:0; margin-left:180px;" />
                ...
                <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home-spoffer-highriseicon.png" width="48" height="52" style="border:0; margin-top:-10px;" />
                <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home-spoffer-liicon.png" width="103" height="28" style="border:0; margin-top:-35px;" />
                <span class="clear"></span>
            </div>
            <div class="clear"></div>
            <div class="laptop">
