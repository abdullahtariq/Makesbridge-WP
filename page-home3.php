<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/home3.css" media="screen" />
<?php 
/* Template Name: Home3 */
            ...
            <div class="trialform">                    
                ...
                <div class="form" style="margin-top:20px; width:400px;">                        
                    ...
                    <div class="spoffer">
                        ...
                        <div class="colright">
                        	<img src="<?php bloginfo('stylesheet_directory'); ?>/images/home3-offer-sficon.png" width="57" height="41" />
                            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home3-offer-nsicon.png" width="53" height="31" style="margin-left:5px; margin-top:-40px;" />
                            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home3-offer-hricon.png" width="33" height="35" />
                            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home3-offer-liicon.png" width="70" height="18" style="margin-left:15px; margin-top:-37px;" />
                        </div>
                    </div>
