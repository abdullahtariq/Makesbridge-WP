<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/home5.css" media="screen" />
<?php 
/* Template Name: Home5 */
...
get_header(); ?>
	...
	<div class="main">    	
    	...
    	<div class="main_wrap" style="position:relative; z-index:1000;">        	
            <div class="clear"></div>
            <!--<a rel="wp-video-lightbox" href="http://vimeo.com/89972365?width=800&height=450">
            <img class="laptop" src="<?php bloginfo('stylesheet_directory'); ?>/images/laptop.png" width="828" height="483" style="border:0;" />
            </a>-->
            <div class="laptop">
            ...
            <div class="trialform">                    
                ...
                <div class="form" style="margin-top:20px; width:400px;">                        
                    ...
                    <div class="spoffer">
                    	<div class="colleft">
                        	<h2>Special Offer!</h2>
                            <p>Subscribe and we’ll pay your subscription to InsideSales.</p>
                        </div>
                        <div class="colright">                        	
                            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home5-spoffer-isicon.png" width="129" height="31" />
                        </div>
                    </div>
                    <a href="" class="license">Ok, I’d Like to know, how you’ll pay InsideSales License.</a>
                    <div class="clear"></div>
