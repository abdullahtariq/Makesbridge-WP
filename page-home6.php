<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/home6.css" media="screen" />
<?php 
/* Template Name: Home6 */
            ...
            <div class="trialform">                    
                ...
                <div class="form" style="margin-top:20px; width:400px;">                        
                    ...
                    <div class="spoffer">
                    	<div class="colleft">
                        	<h2>Special Offer!</h2>
                            <p>Subscribe and we’ll pay your subscription to Linkedin.</p>
                        </div>
                        <div class="colright">                        	
                            <img src="<?php bloginfo('stylesheet_directory'); ?>/images/home6-spoffer-liicon.png" width="126" height="37" />
                        </div>
                    </div>
                    <a href="" class="license">Ok, I’d Like to know, how you’ll pay Linkedin License.</a>
                    <div class="clear"></div>
