...
<html lang="en">
	<head>
		...
		var tgn_value = $('#tgnP-value').text();
		 if(tgn_value){$('#source').val(tgn_value);}
			...
			function validateOfferForm() 
			{
				...
				{					
                    ...
                    $.ajax({
                        url:"<?php echo bloginfo('wpurl'); ?>/wp-admin/admin-ajax.php",
                        type:'POST',
                        data:'action=my_special_ajax_call&act=stgn&' + str,
                        success:function(results)
                        {
...
<span id="tgnP-value" style="display:none;"><?php if($_GET['pmc']){echo $_GET['pmc'];} else{ echo 'tgn-mks';}?></span>
<!-- START: Module -->
...
<?php
			...
			/*if(strpos($_SERVER['REQUEST_URI'],'erpguru') != '' && strpos($_SERVER['REQUEST_URI'],'erpguru') != -1)
			{*/
				$st = "text-transform:uppercase;";
				$mst = "";				
			/*}
			elseif(strpos($_SERVER['REQUEST_URI'],'crm-consultants') != '' && strpos($_SERVER['REQUEST_URI'],'crm-consultants') != -1)
			{
				$st = "text-transform:uppercase;";
				$mst = "";
			}
			...
			{
				$st = "font-family: proxima_nova_semibold;font-size: 43px;line-height: 1em;text-align: left;text-transform: uppercase;width: 620px;";
				$mst = "text-align: left";
			}*/
			?>
<!-- START: Module -->
<div class="mainfull slider border_box" style="background:url(<?php echo $background_image["url"]; ?>) no-repeat center center; background-size: cover; width: 100%; height: 100%;">
	<div class="main_wrap">
		<div class="slider_wrap">
        		<div class="clr"></div>
                <div class="slider_left" style="<?php echo $mst; ?>">
                    <div class="slider_left_content">
                        <p class="slider_h1" style="<?php echo $st; ?>"><?php the_field('bann_head'); ?></p>
                        <?php
                        if($sub_head)
						{
						?>
                        	<p class="slider_p"><?php echo $sub_head; ?></p>
                        <?php
						}
						?>
...
<!-- START: Module -->
<div class="mainfull border_box" style="background-color: #ecf3fa;">
	<div class="main_wrap">
		  <div id="connections_sec2">
			<div class="main_wrap">
			  <?php
				$connections_sec2 = get_post(1224); 
