<?php
/* Template Name: New Responsive (LP2) */
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<style type="text/css">
			.slider{padding: 67px 0px; background: #ecf3fa url(<?php bloginfo('stylesheet_directory'); ?>/mks_lp_r/images/bg_slider2.jpg) center center no-repeat; background-size: cover; width: 100%; height: 100%;}
		</style>
