...
<div id="pricing_page">
  ...
  <div class="topbanner pricing_topbanner">
    <div class="free-signup-wrap">
      <div class="main_wrap free-signup"> <div class="left left-free-wrapper">
      	<div class="email-millions-wrap ">
      	<h2>Send email to millions</h2>
     	<p><?php //the_field('bann_desc'); 
    ...
    <div class="right right-free-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/images/freetrial.png" /></div></div>
    </div>
  ...
  <div class="main" >
    <div class="price-calculator-wrap">    	
    	<div id="calculator">
  ...
  <div class="main">
    <div class="main_wrap">
      ...
      <div id="features" class="features" style="display:none;">
...
<div class="signuppop wp-pop" id="features_now" >
	<div class="packages" style="display:none;">
        <h1>You get all these extras when you sign up!</h1> 
        <div class="clear"></div>
      	<div class="package-spend"><h2>If you spend</h2></div>
      	<div class="clear"></div>
      	<div class="packages-prices-wrapper">
      		<div class="package-price">
			  <div class="package-price-container" id="tile-mini" style="padding: 0px 0px 0px 10px; text-align: center; border: 1px solid rgb(71, 153, 195); height: 100px; margin-left: 2px; width: 185px;">
			    
			    <sup class="pkgprice">$</sup>
			    <h3 class="price"><b>29</b></h3>
			    <sub class="pkgperiod">/mo</sub>
			    
			  </div>
			</div>
			<div class="package-price">
			  <div class="package-price-container" id="tile-smb" style="padding: 0px 0px 0px 10px; text-align: center; border: 1px solid rgb(71, 153, 195); height: 100px; margin-left: 2px; width: 185px;">
			    
			    <sup class="pkgprice">$</sup>
			    <h3 class="price"><b>75</b></h3>
			    <sub class="pkgperiod">/mo</sub>
			    
			  </div>
			</div>
			<div class="package-price">
			  <div class="package-price-container" id="tile-pro" style="padding: 0px 0px 0px 10px; text-align: center; border: 1px solid rgb(71, 153, 195); height: 100px; margin-left: 2px; width: 185px;">
			    
			    <sup class="pkgprice">$</sup>
			    <h3 class="price"><b>150</b></h3>
			    <sub class="pkgperiod">/mo</sub>
			    
			  </div>
			</div>
			<div class="package-price">
			  <div class="package-price-container" id="tile-ent" style="padding: 0px 0px 0px 10px; text-align: center; border: 1px solid rgb(71, 153, 195); height: 100px; margin-left: 2px; width: 185px;">
			    
			    <sup class="pkgprice" style="left: 10px;">$</sup>
			    <h3 class="price" style="margin-left: 10px;"><b>500</b></h3>
			    <sub class="pkgperiod">/mo</sub>
			    
			  </div>
			</div>
			<div class="package-price">
			  <div class="package-price-container" id="tile-eng" style="padding: 0px 0px 0px 10px; text-align: center; border: 1px solid rgb(71, 153, 195); height: 100px; margin-left: 2px; width: 185px;">
			    
			    <sup class="pkgprice" style="left: 0px;">$</sup>
			    <h3 class="price" style="margin-left: 0px;"><b>1500</b></h3>
			    <sub class="pkgperiod">/mo</sub>
...
<div class="package-price" style="display:none;">
  <div class='package-price-container' style="<?php echo $pcw; ?>">
    ...
    <div class="clear"></div>
          ...
          <div style="display:none;" class="package-salesforce" <?php echo $sftop; ?>> <a href="#features" onclick="return opendetail('<?php echo $boxid; ?>')">
            <h2>See Feature Details</h2>
            </a> </div>
          <div class="package-buttons" style="display:none;">
