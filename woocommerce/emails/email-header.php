                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" width="600" id="template_container" style="<?php echo $template_container; ?>">
                        	<tr>
                              <td align="center" valign="middle" style="height:105px;">
                                  <a href="http://www.makesbridge.com" title="Makesbridge"><img style="border:0;" alt="Makesbridge" src="http://www.makesbridge.com/wp-content/themes/mksteam/images/logo.png" width="204" height="47"></a>
                              </td>
                            </tr>
                        	<tr>
                            	<td align="center" valign="middle">
                                    <!-- Header -->
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="template_header" style="<?php echo $template_header; ?>" bgcolor="#067ab5">
                                        <tr>
                                            <td>
