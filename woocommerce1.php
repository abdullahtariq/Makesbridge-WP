  ...
  <div class="topbanner pricing_topbanner">
    ...
    <div class="monthly-billing-wrap" style="background:#F7F9FB;">
      <div class="monthly-wrap monthly-billing">
        ...
        Montly billing, no contracts. Because we know our clients don't want to go anywhere else.
      </div>
    </div>
  </div>
  <?php
    ...
    <div class="main_wrap">    	
      <div class="packages">
        ...
        <div class="shareprpage" style="right:0;">
            <div class="clear"></div>
            <img width="19" height="17" style="border:0;" alt="" src="http://thisweek.makesbridge.com/wp-content/themes/mksteam/images/dir-arrow.png" class="dirarrow">
            <a title="Email this page" class="sharelink" href="mailto:">Share this page</a>
            <a title="Print" class="print" href="#"><img width="18" height="18" style="border:0" alt="" src="http://thisweek.makesbridge.com/wp-content/themes/mksteam/images/print-icon.png"></a>
            <a title="Save as PDF" class="download" target="_blank" href="http://thisweek.makesbridge.com/wp-content/plugins/kalins-pdf-creation-station/kalins_pdf_create.php?singlepost=pg_48"><img width="16" height="18" style="border:0" alt="" src="http://thisweek.makesbridge.com/wp-content/themes/mksteam/images/download-icon.png"></a>            
            <div class="clear"></div>
        </div> 
        <div class="clear"></div> 
